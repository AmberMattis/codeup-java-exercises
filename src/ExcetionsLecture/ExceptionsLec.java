package ExcetionsLecture;

import java.util.ArrayList;
import java.util.Scanner;

public class ExceptionsLec {
    //Exceptions are tools to handle errors
    //Built -in Exception class - An object with the type Exception
    //Ther is ususally a message that describes what wen wrong
    //Exception are Thrown when an application ca't perform an operation

    //The try catch block We dont want to crash our apllications,
    // we can manage this by cathcing exception

    //Catch blocks go from more specific to less specific
