...
public class consoleIO_lecture {
...
//        System.out.println("Hello" + " " + "World");
        ...
        ****************************************/
        ...
        //They will output on the same line

        //System.out.printf("Hello%n");
        //System.out.printf("World");
        //souts on seperate lines due to %n after hello

        String name = "Amber";
        System.out.printf("Hello %s%n", name); //Hello Amber
        ...
        //TODO: Remove the %n from the first printf. What do you notice?
            //There was not a new line all the words were next to each other
...
//        String pet = "fish";
//
//        System.out.printf("I have %d %s.%n", five, pet); //I have 5 fish.
...
//
//        System.out.printf("I wake up at %d am every %s.%n", nine, weekend);
...
//        //.2f is telling the computer you want to use 2 decimal places. This moves the decimal 2 places left in the currencyPennies.
        ...
        ****************************************/
        ...
        Scanner userInput = new Scanner(System.in); //System.in means the stuff we are trying to capture is coming from the console
...
//        System.out.println(age);
        ...
        System.out.println("Enter Your favorite quate");
